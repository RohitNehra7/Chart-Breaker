        ...
        <nav className="navbar shadow-lg">
            <div className="container flex justify-between items-center py-4">
                ...
                <div className="logo text-3xl font-bold text-white">
                    <span className="text-blue-400">Stock</span> <span className="text-orange-400">GPT</span>
                </div>
                {/* Desktop Nav Links */}
                <div className="nav-links hidden md:flex space-x-8">
                    <Link to="/" className="nav-link">Home</Link>
                    <Link to="/portfolio-analysis" className="nav-link">Portfolio Analysis</Link>
            ...
            {isOpen && (
                <div className="mobile-menu md:hidden flex flex-col space-y-4 bg-gray-800 p-4">
                    ...
                    <Link to="/portfolio-analysis" className="mobile-link" onClick={() => setIsOpen(false)}>Portfolio Analysis</Link>
                    <Link to="/ai-analysis" className="mobile-link" onClick={() => setIsOpen(false)}>AI Analysis</Link>
                </div>
            )}
        </nav>
    );

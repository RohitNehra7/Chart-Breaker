...
exports.getStockInfo = exports.getDeliverableQuantities = exports.getAutoComplete = exports.getAllIndicesList = exports.getStockList = void 0;
...
const getAutoComplete = async (req, res) => {
    ...
    try {
        const indicesList = await (0, stockService_1.fetchAutoCompleteResults)(query);
        const response = {
            success: true,
            data: indicesList,
        };
...
const getDeliverableQuantities = async (req, res) => {
    const { from, to, symbol } = req.query;
    try {
        const deliverableQuantityData = await (0, stockService_1.fetchDeliverableQuantities)(from, to, symbol);
        const response = {
            success: true,
...
exports.getDeliverableQuantities = getDeliverableQuantities;
